...
import {MorphoAaveKnockout} from "../../contracts/instruments/MorphoAaveKnockout.sol";
...
contract MorphoAaveKnockoutTest is DSTest {
    ...
    function testCreatePosition() public {
        ...
        MorphoAaveKnockout position = new MorphoAaveKnockout(
            MORPHO,
            MORPHO_LENS
        );
        ...
        console.log(
            "Amount before: ",
            IERC20(collateralAddress).balanceOf(alice)
        );
        ...
        uint256 tokenId = position.create(
            collateralAddress,
            AETH,
